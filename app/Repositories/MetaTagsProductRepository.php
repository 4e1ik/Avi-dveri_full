    ...
    private const PRODUCTS = [
        'door' => [ //productType
            ...
            'interior' => [ //type
                ...
                'Флекс эмаль' => 'Межкомнатные двери - Флекс эмаль', //material
                'Массив + МДФ' => 'Межкомнатные двери - Массив + МДФ', //material
                'МДФ' => 'Межкомнатные двери - МДФ', //material
                'МДФ+ХДФ' => 'Межкомнатные двери - МДФ+ХДФ', //material
            ]
        ],
        'fitting' => [ //productType
