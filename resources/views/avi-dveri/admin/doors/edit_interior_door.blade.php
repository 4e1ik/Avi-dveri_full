...
{{--                            </div>--}}
                                    ...
                                    <div class="col-md-11 padding-0">
                                        <select @error('function') style="color: #FF6656" class="form-control danger" @enderror class="form-control" name="function">
                                            ...
                                            @else
                                                ...
                                                @enderror
                                                <option {{ $product->door->function == 'Квартира' ? 'selected' : ''}}  value="Квартира" selected>
                                                    Квартира
                                                </option>
                                        </select>
                                    </div>
                            ...
                            @include('avi-dveri.admin.partials.door_attrs_checkboxes', ['type' => 'interior', 'product' => $product])
