                                ...
                                <div class="row">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <a href="single-product.html"><img
                                                            src="{{asset('/avi-dveri_assets/avi-dveri/img/product/6.jpg')}}"
                                                            alt=""/></a>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <a href="single-product.html"><img
                                                            src="{{asset('/avi-dveri_assets/avi-dveri/img/product/3.jpg')}}"
                                                            alt=""/></a>
                                            </div>
                                            <div class="product-info clearfix text-center">
                                                <div class="fix">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="single-product.html"><img
                                                            src="{{asset('/avi-dveri_assets/avi-dveri/img/product/7.jpg')}}"
                                                            alt=""/></a>
                                            </div>
                                            <div class="product-info clearfix text-center">
                                                <div class="fix">
