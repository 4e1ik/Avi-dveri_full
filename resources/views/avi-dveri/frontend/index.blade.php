                    ...
                    <div class="title-container s-tb-c title-compress">
                        <div class="layer-1">
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="3.5s" data-wow-delay="0.5s">
                                <a href="{{route('interior_doors')}}" class="button-one style-2 text-uppercase mt-20" data-text="Каталог">Каталог</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="slider-content t-lfl s-tb slider-1">
                    <div class="title-container s-tb-c title-compress">
                        <div class="layer-1">
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="3.5s" data-wow-delay="0.5s">
                                <a href="{{route('entrance_doors')}}" class="button-one style-2 text-uppercase mt-20" data-text="Каталог">Каталог</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="slider-content t-lfl s-tb slider-1">
                    <div class="title-container s-tb-c title-compress">
                        <div class="layer-1">
                            ...
                            <div class="wow fadeInUpBig" data-wow-duration="3.5s" data-wow-delay="0.5s">
                                <a href="{{route('accessories')}}" class="button-one style-2 text-uppercase mt-20" data-text="Каталог">Каталог</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-banner banner-1 banner-4">
                        <a class="banner-thumb" href="{{route('entrance_doors')}}"><img src="{{asset('/avi-dveri_assets/frontend/img/banner/2.png')}}" alt="" /></a>
                        <div class="background__banner"></div>
                        <div class="banner-brief">
                            <h2 class="banner-title"><a href="{{route('entrance_doors')}}">Входные</a></h2>
                            <p class="mb-0">двери</p>
                        </div>
                        <a href="{{route('entrance_doors')}}" class="button-one font-16px" data-text="Перейти">Перейти</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-banner banner-1 banner-4">
                        <a class="banner-thumb" href="{{route('interior_doors')}}"><img src="{{asset('/avi-dveri_assets/frontend/img/banner/1.png')}}" alt="" /></a>
                        <div class="background__banner"></div>
                        <div class="banner-brief">
                ...
                <div class="col-md-4">
                    <div class="single-banner banner-1 banner-4">
                        <a class="banner-thumb" href="{{route('accessories')}}"><img src="{{asset('/avi-dveri_assets/frontend/img/banner/3.png')}}" alt="" /></a>
                        <div class="background__banner"></div>
                        <div class="banner-brief">
