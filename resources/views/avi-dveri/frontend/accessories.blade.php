                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <aside class="widget widget-color mb-30">
                        ...
                        <div class="widget-info color-filter clearfix">
                            <ul>
                                <li><input type="checkbox" class="func_checkbox"><a href="#">Эконом<span class="count">12</span></a></li>
                                <li><input type="checkbox" class="func_checkbox"><a href="#">Стандарт<span class="count">20</span></a></li>
                                <li><input type="checkbox" class="func_checkbox"><a href="#">Премиум<span class="count">33</span></a></li>
                            </ul>
                        </div>
                    </aside>
