                            ...
                            <div class="tab-pane active" id="delivery">
                                <div class="pro-tab-info pro-reviews">
                                    <div class="customer-review mb-60">
                                        ...
                                        <img src="{{asset('/avi-dveri_assets/frontend/img/KSA.jpg')}}" alt="Картинка оплата">
                                    ...
                                    <p>Вы оплачиваете вышеуказанный аванс наличными. После проверки комплектности и качества товаров оплачиваете остаток. При оплате вы получаете кассовый чек, который является основанием для замены и возврата товара.</p>
                                    <h3 class="tab-title title-border mb-30">Банковскими картами</h3>
                                    <p>Принимаем к оплате платежные карты Белкарт, Visa, MasterCard (оплата через терминал). При оплате банковской картой возврат денежных средств в случае такой необходимости осуществляется на карточку, с которой была произведена оплата.</p>
                                    <img src="{{asset('/avi-dveri_assets/frontend/img/oplata_bankovskoy_kartoy_onlayn.png')}}" alt="Картинка оплаты картами">
                                    <h3 class="tab-title title-border mb-30">В рассрочку</h3>
                                    <p>Мы предоставляем возможность выгодного приобретения дверей в рассрочку от 3 до 12 месяцев по картам:</p>
                                    <p>⦾ Халва (МТБ);</p>
                                    ...
                                    <p>Также в нашем магазине регулярно проходят акции и действуют скидки для постоянных клиентов. Внимание: Акции и скидки на приобретаемый товар в рассрочку не распространяются.</p>
                                    <img src="{{asset('/avi-dveri_assets/frontend/img/vaerrr.jpg')}}" alt="Картинка карты">
                                </div>
                            </div>
                        </div>
                    </div>
