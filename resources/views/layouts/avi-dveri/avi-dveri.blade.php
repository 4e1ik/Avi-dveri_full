...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-TCM9F2TW');
    </script>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('/avi-dveri_assets/avi-dveri/img/logo/logo_1.webp') }}">
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TCM9F2TW" height="0" width="0"
    ...
    <div class="wrapper bg-dark-white">
        <header class="header">
            <div class="header-inner">
                ...
                <nav class="header-nav" aria-label="Основное меню">
                    ...
                    <div class="header-menu dropdown-catalog">
                        <a href="{{ route('catalog') }}" class="catalog-link">Каталог</a>
                ...
                <div class="header-tools">
                    ...
                    <button type="button" class="button-one submit-btn-4 open_popup_callback"
                        data-text="Заказать звонок">Заказать звонок</button>
                </div>
        ...
        <div class="mobile-menu-area">
            <div class="container-fluid">
                <a class="header-logo-link mobile-header__logo" href="{{ route('home') }}"><img
                        src="{{ asset('/avi-dveri_assets/avi-dveri/img/logo/logo2.webp') }}" alt="Ави-двери"
        ...
        <div class="mobile-search-modal" id="mobileSearchModal" aria-hidden="true" role="dialog" aria-modal="true"
            ...
            <div class="popup__body popup__body_mobile_search">
                <div class="mobile-search-modal__panel">
                    <div class="mobile-search-modal__header form__text">
                        ...
                        <div class="popup__cross_mobile_search" data-mobile-search-close role="button"
                            tabindex="0" aria-label="Закрыть">✕</div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="single-footer">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="{{ route('warranty') }}"><i
                                                class="zmdi zmdi-dot-circle"></i>Гарантия</a></li>
                                    <li><a href="{{ route('promotions') }}"><i
                                                class="zmdi zmdi-dot-circle"></i>Акции</a></li>
                                    <li><a href="{{ route('payment_and_delivery') }}"><i
                                                class="zmdi zmdi-dot-circle"></i>Оплата и доставка</a></li>
                                    <li><a href="{{ route('contacts') }}"><i
                                                class="zmdi zmdi-dot-circle"></i>Контакты</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 footer-text">
                            ...
                            <p>ИП Исаев Андрей Владимирович, УНП 690311744, свидетельство о государственной регистрации
                                ...
                                от 15.11.2004 г.</p>
                            <p>По вопросам покупателей о защите их прав:<br><a href="tel:375293673518">+375 (29)
                                    367-35-18</a><br><a href="mailto:3673518@mail.ru">3673518@mail.ru</a></p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                ...
                                <p class="mb-0">Developed by <a href="https://t.me/ArtemiSevostian" target="_blank"
                                        rel="nofollow noopener noreferrer">Artemi Sevostian</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function showErrors(errors, form) {
            ...
            Object.entries(errors).forEach(([field, messages]) => {
                ...
                if (inputOrTextarea) {
                    ...
                    const errorContainer = inputOrTextarea.closest('.feedback__input')?.querySelector(
                        '.form_error');
