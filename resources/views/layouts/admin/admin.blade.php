...
<head>
    ...
    <![endif]-->
    <script src="https://cdn.tiny.cloud/1/66nx74eenxayqxwnteavi6ds4jqmjqit1aypcupq14d9bu0n/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
</head>
        ...
        <div class="navbar-header" style="width:100%;">
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="dropdown avatar-dropdown">
                    <img src="{{asset('/avi-dveri_assets/admin/img/avatar.jpg')}}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
...
{{--                <input type="text" placeholder="search.."/>--}}
            ...
            <div class="user col-md-12">
                <ul class="nav nav-list">
                    <li class="online">
                        <img src="{{asset('/avi-dveri_assets/admin/img/avatar.jpg')}}" alt="user name">
                        <div class="name">
                        ...
                        <div class="msg_container_base">
                            <div class="row msg_container send">
                                ...
                                <div class="col-md-3 col-xs-3 avatar">
                                    <img src="{{asset('/avi-dveri_assets/admin/img/avatar.jpg')}}" class=" img-responsive " alt="user name">
                                </div>
                            </div>
                    ...
                    <ul>
                        <li class="online">
                            <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                <div class="user-avatar"><img src="{{asset('/avi-dveri_assets/admin/img/avatar.jpg')}}" alt="user name"></div>
                                <div class="dot"></div>
                            </a>
                        </li>
                        <li class="offline">
        ...
        <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
            <ul class="nav nav-list">
                ...
                <li class="ripple">
                    ...
                    <ul class="nav nav-list tree" style="display: none;">
                        <li><a href="">Картинки страницы кашпо</a></li>
                        <li><a href="">Картинки страницы скамеек</a></li>
                        <li><a href="">Картинки главной страницы</a></li>
                        <li><a href="">Картинки страницы декоративных элементов</a></li>
                        <li><a href="">Картинки страницы боллард</a></li>
                        <li><a href="">Картинки страницы парклетов и навесов</a></li>
                        <li><a href="">Картинки страницы столбов и накрывок</a></li>
                        <li><a href="">Картинки страницы фасадных лепнин и панелей</a></li>
                        <li><a href="">Картинки страницы ротонд и коллонад</a></li>
                    </ul>
                </li>
            </ul>
        </div>
